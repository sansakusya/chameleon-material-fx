...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "skin02R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "skin02G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "skin02B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "skin02V-";>;
