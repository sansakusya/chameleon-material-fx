...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "skin01R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "skin01G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "skin01B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "skin01V-";>;
...
const float normalSubMapLoopNum = 200.0;
