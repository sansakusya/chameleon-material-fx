...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "cloth03R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "cloth03G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "cloth03B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "cloth03V-";>;
...
static const float3 albedoSub = 0.98;
...
#define NORMAL_MAP_FILE "../_NormalMap/NMcloth.png"
...
#define NORMAL_SUB_MAP_FILE "../_NormalMap/NMswim.png"

const float normalSubMapScale = 0.2;
const float normalSubMapLoopNum = 60;
