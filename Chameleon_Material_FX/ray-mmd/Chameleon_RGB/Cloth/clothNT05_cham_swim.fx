...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "cloth05R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "cloth05G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "cloth05B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "cloth05V-";>;
