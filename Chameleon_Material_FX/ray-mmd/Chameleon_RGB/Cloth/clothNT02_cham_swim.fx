...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "cloth02R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "cloth02G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "cloth02B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "cloth02V-";>;
