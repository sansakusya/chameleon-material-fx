...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "cloth01R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "cloth01G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "cloth01B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "cloth01V-";>;
