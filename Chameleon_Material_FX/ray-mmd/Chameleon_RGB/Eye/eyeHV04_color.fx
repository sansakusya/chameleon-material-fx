...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eye04R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eye04G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eye04B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eye04V-";>;

static const float3 albedo = float3(2*mR, 2*mG, 2*mB) * (10-10*mV);
...
float mER : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eye04R+";>;
float mEG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eye04G+";>;
float mEB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eye04B+";>;
float mEV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eye04V-";>;

static const float3 emissive = float3(2*mER, 2*mEG, 2*mEB) * (1-mEV);
