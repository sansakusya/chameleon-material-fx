...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eye05R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eye05G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eye05B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eye05V-";>;
...
float mER : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eye05R+";>;
float mEG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eye05G+";>;
float mEB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eye05B+";>;
float mEV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eye05V-";>;
