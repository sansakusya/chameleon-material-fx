...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "mouth02R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "mouth02G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "mouth02B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "mouth02V-";>;
...
const float normalSubMapLoopNum = 200;
