...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "clear05R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "clear05G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "clear05B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "clear05V-";>;
