...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "clear01R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "clear01G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "clear01B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "clear01V-";>;
