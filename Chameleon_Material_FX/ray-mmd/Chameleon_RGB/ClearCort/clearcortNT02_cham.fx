...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "clear02R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "clear02G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "clear02B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "clear02V-";>;
