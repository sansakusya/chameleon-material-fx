...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "metal02R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "metal02G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "metal02B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "metal02V-";>;
