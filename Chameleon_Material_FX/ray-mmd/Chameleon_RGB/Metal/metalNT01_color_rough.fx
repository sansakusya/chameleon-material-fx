...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "metal01R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "metal01G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "metal01B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "metal01V-";>;
