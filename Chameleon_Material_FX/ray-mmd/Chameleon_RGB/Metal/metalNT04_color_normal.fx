...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "metal04R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "metal04G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "metal04B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "metal04V-";>;

static const float3 albedo = float3(1.2*mR, 1.2*mG, 1.2*mB) * (1-mV);
