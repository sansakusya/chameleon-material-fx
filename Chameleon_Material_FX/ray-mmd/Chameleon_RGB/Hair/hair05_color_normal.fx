...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "hair05R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "hair05G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "hair05B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "hair05V-";>;
