...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "hair01R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "hair01G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "hair01B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "hair01V-";>;
...
#define NORMAL_MAP_FILE "../_NormalMap/hair_normal.jpg"
