...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive02R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive02G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive02B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive02V-";>;
...
float mER : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive02R+";>;
float mEG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive02G+";>;
float mEB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive02B+";>;
float mEV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive02V-";>;
