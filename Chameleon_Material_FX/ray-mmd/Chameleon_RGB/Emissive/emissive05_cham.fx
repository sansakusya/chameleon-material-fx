...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive05R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive05G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive05B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive05V-";>;
...
float mER : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive05R+";>;
float mEG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive05G+";>;
float mEB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive05B+";>;
float mEV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive05V-";>;
