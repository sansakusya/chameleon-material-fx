...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive03R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive03G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive03B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive03V-";>;
...
float mER : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive03R+";>;
float mEG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive03G+";>;
float mEB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive03B+";>;
float mEV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive03V-";>;
