...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive04R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive04G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive04B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive04V-";>;

static const float3 albedo = float3(1*mR, 1*mG, 1*mB);
...
float mER : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive04R+";>;
float mEG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive04G+";>;
float mEB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive04B+";>;
float mEV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive04V-";>;

static const float3 emissive = float3(mER, mEG, mEB);
const float3 emissiveBlink = 1.0;
static const float  emissiveIntensity = 10 - float(mEV)*10;
