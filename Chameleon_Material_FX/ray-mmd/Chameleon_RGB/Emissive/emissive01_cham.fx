...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive01R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive01G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive01B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive01V-";>;
...
float mER : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive01R+";>;
float mEG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive01G+";>;
float mEB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive01B+";>;
float mEV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive01V-";>;
