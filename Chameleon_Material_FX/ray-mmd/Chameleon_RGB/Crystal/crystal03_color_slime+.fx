...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "crystal03R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "crystal03G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "crystal03B+";>;
