...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "crystal01R+";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "crystal01G+";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "crystal01B+";>;
float mV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "crystal01V-";>;
