...
float mH : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive04H";>;
float mS: CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive04S";>;
...
float mEH : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive04H";>;
float mES : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive04S";>;
