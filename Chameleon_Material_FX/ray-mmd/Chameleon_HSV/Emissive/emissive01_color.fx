...
float mH : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive01H";>;
float mS: CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive01S";>;
...
float mEH : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive01H";>;
float mES : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive01S";>;
