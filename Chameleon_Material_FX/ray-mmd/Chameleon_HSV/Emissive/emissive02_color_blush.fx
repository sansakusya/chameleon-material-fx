...
#define CONTROLLER_NAME "ray_chameleon_controller_HSV.pmx"
float mH : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive02H";>;
float mS: CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive02S";>;
...
float mEH : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive02H";>;
float mES : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive02S";>;
float mEV : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive02V";>;

static const float3 hsve = float3(mEH, mES, mEV);
static float3 rgbe = HSVtoRGB(hsve);
static const float3 emissive = float3(rgbe.r, rgbe.g, rgbe.b);
const float3 emissiveBlink = 1.0;
static const float  emissiveIntensity = float(mEV)*10;
