...
float mH : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive03H";>;
float mS: CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive03S";>;
...
float mEH : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive03H";>;
float mES : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "emissive03S";>;
